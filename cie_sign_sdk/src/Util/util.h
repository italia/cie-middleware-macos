...
#define ERR_GET_PRIVATE "Impossibile determinare se un oggetto Ë privato"
...
#define ERR_KEY_NOT_SECAUTH "La chiave non Ë protetta con secondary authentication"
